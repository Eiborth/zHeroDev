  ...
  <header class="header particle-title" >
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <br>
        <br>
        Considero la comunicación y el uso de las metodologías ágiles, herramientas esenciales para lograr entregables de calidad. Sí consideras que estas habilidades te pueden ser útiles, estoy a la disposición de conversar contigo.
      </h5>   
