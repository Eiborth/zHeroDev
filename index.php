...
<body id="particleWrapper">
  ...
  <header class="header particle-title" >
    ...
    <nav class=" animated fadeIn delay-5s navbar navbar-expand-lg">
      <!-- Logo -->
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-6">
          ...
          <h5 class="maquina_escribir animated fadeIn delay-0.9s" id="texto" ></h5>       
        </div>
        <div class="animated fadeIn delay-5s col-lg-6">
         <div class="proyectos_intro"  alt="intro"></div>   
       </div>
     </div>
   </div>
   <!-- Pie de pagina -->
   <footer style="top: 10%" class="main-footer animated fadeIn delay-5s">
    <div class="container ">
